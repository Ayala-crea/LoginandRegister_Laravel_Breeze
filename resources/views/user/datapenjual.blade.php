...
<body class="bg-gray-100">
    ...
    <div class="h-screen flex flex-row flex-wrap">
        ...
        <div id="sideBar"
            ...
            <div class="flex flex-col">
                ...
                <a href="{{ route('home') }}"
                    ...
                    <i class="fad fa-chart-pie text-xs mr-2"></i>
                    Menu Makanan
                <a href="{{ route('menu.user.minuman') }}"
                    class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
                    <i class="fad fa-chart-pie text-xs mr-2"></i>
                    Menu Minuman
                </a>
        ...
        <!-- strat content -->
        <div class="ml-20 content px-4 py-6">
            <!-- component -->
            <div class="mb-9 text-center">
                <h1 class="mb-2 text-[1.75rem] font-semibold text-dark">OUR TEAM KANTIN KAMPOES.</h1>
                <span class="text-[1.15rem] font-medium text-muted"> Team yang berhasil menciptakan antara citarasa dengan teknologi. </span>
            </div>
            <div class="grid grid-cols-2 gap-6">
                <div class="flex flex-col">
                    <div class="-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                        <img class="inline-block shrink-0 rounded-[.95rem] w-[100px] h-[100px]"
                            src="{{ asset('images/qinthar.jpg') }}"
                            alt="avatar image">
                    </div>
                    <div class="text-center">
                        <a href="javascript:void(0)"
                            class="text-dark font-semibold hover:text-primary text-[1.25rem] transition-colors duration-200 ease-in-out">Muhammad Qinthar</a>
                        <span class="block font-medium text-muted">CEO at KANTIN KAMPOES.</span>
                    </div>
                </div>
                <div class="flex flex-col">
                    <div class="-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                        <img class="inline-block shrink-0 rounded-[.95rem] w-[150px] h-[150px]"
                            src="{{ asset('images/alfian.jpg') }}"
                            alt="avatar image">
                    </div>
                    <div class="text-center">
                        <a href="javascript:void(0)"
                            class="text-dark font-semibold hover:text-primary text-[1.25rem] transition-colors duration-200 ease-in-out">Alfian Benardo Rusli</a>
                        <span class="block font-medium text-muted">Director at KANTIN KAMPOES.</span>
                    </div>
                </div>
                <div class="flex flex-col">
                    <div class="-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                        <img class="inline-block shrink-0 rounded-[.95rem] w-[150px] h-[150px]"
                            src="{{ asset('images/ibu1.jpg') }}"
                            alt="avatar image">
                    </div>
                    <div class="text-center">
                        <a href="javascript:void(0)"
                            class="text-dark font-semibold hover:text-primary text-[1.25rem] transition-colors duration-200 ease-in-out">Bu Imas</a>
                        <span class="block font-medium text-muted">Head Chef</span>
                    </div>
                </div>
                <div class="flex flex-col">
                    <div class="-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                        <img class="inline-block shrink-0 rounded-[.95rem] w-[150px] h-[150px]"
                            src="{{ asset('images/ibu2.jpg') }}"
                            alt="avatar image">
                    </div>
                    <div class="text-center">
                        <a href="javascript:void(0)"
                            class="text-dark font-semibold hover:text-primary text-[1.25rem] transition-colors duration-200 ease-in-out">Bu Surti</a>
                        <span class="block font-medium text-muted">Chef</span>
                    </div>
                </div>
                <div class="flex flex-col">
                    <div class="-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                        <img class="inline-block shrink-0 rounded-[.95rem] w-[150px] h-[150px]"
                            src="{{ asset('images/ibu3.jpg') }}"
                            alt="avatar image">
                    </div>
                    <div class="text-center">
                        <a href="javascript:void(0)"
                            class="text-dark font-semibold hover:text-primary text-[1.25rem] transition-colors duration-200 ease-in-out">Bu Tanti</a>
                        <span class="block font-medium text-muted">Chef</span>
                    </div>
                </div>
                <div class="flex flex-col">
                    <div class="-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                        <img class="inline-block shrink-0 rounded-[.95rem] w-[150px] h-[150px]"
                            src="{{ asset('images/ibu4.jpg') }}"
                            alt="avatar image">
                    </div>
                    <div class="text-center">
                        <a href="javascript:void(0)"
                            class="text-dark font-semibold hover:text-primary text-[1.25rem] transition-colors duration-200 ease-in-out">Bu Mila</a>
                        <span class="block font-medium text-muted">Chef</span>
                    </div>
                </div>
            </div>
