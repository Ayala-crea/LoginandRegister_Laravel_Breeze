                ...
                <div class="dropdown relative md:static">
                    ...
                    <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
                        <div class="ml-2 capitalize flex">
                            <a class="btn btn-outline-dark" href="{{ route('shopping.cart.makanan') }}">
    ...
    <div class="h-screen flex flex-row flex-wrap">
        ...
        <div id="sideBar"
            ...
            <div class="flex flex-col full">
                ...
                <p class="uppercase text-xs text-gray-600 mb-4 tracking-wider">Menu Jualan</p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                                    <a href="#">
                                        <img class="p-8 rounded-t-lg w-full-x1" src="{{ asset($item->image) }}"
                                            alt="product image" />
                                    </a>
                                    <div class="px-5 pb-5">
                                        <a href="#">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <span
                                                class="text-3xl font-bold text-gray-900">Rp{{ $item->harga }}.000</span>
                                            <button class="btn-holder">
                                                <a href="{{ route('cart.produk.makanan', $item->id) }}"
