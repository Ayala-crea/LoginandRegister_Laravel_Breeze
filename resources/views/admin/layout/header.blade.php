    ...
    <div
        ...
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                <span class="text-white text-lg ml-3"> Dashboard Kantin Kampoes </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
                ...
                <div class="dropdown-menu w-56">
                    <ul
                        ...
                        <li class="p-2">
                            ...
                            <div class="text-xs text-white/60 mt-0.5">Software Engineer</div>
                        </li>
                        <li>
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('Admin.menu.minuman') }}" class="side-menu side-menu--active">
                            <div class="side-menu__title">
                                Data menu Minuman
                            </div>
                        </a>
                    ...
                    <li>
                        <a href="{{ route('Data.Absensi') }}" class="side-menu side-menu--active">
                            <div class="side-menu__title">
                                Data Staff
                            </div>
                        </a>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="text-gray-600 hover:text-gray-800 focus:outline-none bg-transparent border-none">
                            Logout
                        </button>
                    </form>
                </ul>
